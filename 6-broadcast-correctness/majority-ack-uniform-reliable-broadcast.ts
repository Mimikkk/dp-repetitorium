 ...
 * - Model przetwarzania oparty o {@link ProcessingModel.FailSilent awarii ukrytymi}.
 * - Poprawność większości procesów.
    ...
    await waitfor(() => {
      packets = [...self.pending]
        ...
        .filter((packet) => {
          ...
          return issubsetof(self.correct, hasTransmitted) && hasTransmitted.size > processes.length / 2;
        });
